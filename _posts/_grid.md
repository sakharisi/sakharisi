...
![Схематичный вид грид-линии колонки.]({{ site.url }}/assets/images/1.png)
Синяя линия — грид-линия колонки.

**Грид-ячейка**: пространство между соседними грид-линиями. Единица грид-сетки.

![Схематичный вид грид-ячейки между первой и второй грид-линиями ряда и второй и третьей грид-линиями колонки.]({{ site.url }}/assets/images/2.png)
...
![Схематичный вид горизонтальной грид-полосы между первой и второй грид-линиями ряда.]({{ site.url }}/assets/images/3.png)
...
![Схематичный вид грид-области между первой и третьей грид-линиями ряда и первой и третьей грид-линиями колонки.]({{ site.url }}/assets/images/4.png)
...
![Пример реализации свойств grid-template-columns, grid-template-rows.]({{ site.url }}/assets/images/5.png)
...
![Пример реализации свойств grid-template-columns, grid-template-rows с использованием именования грид-линий с помощью квадратных скобок.]({{ site.url }}/assets/images/6.png)
